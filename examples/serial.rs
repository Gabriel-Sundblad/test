...
/// Statisk clocks-lagring för att kunna ge `'static` referens till USB
pub static mut CLOCKS: Option<Clocks<ExternalOscillator, Internal, LfOscStarted>> = None;

/// Statisk USB-bus allokator – för att ge `'static` referens till USB stacken
...
impl Serial {
    pub fn new(clock: CLOCK, usbd: USBD) -> Self {
        ...
        // Skapa SerialPort och UsbDevice
    ...
    /// Pollar USB-stack för att hantera inkommande data
